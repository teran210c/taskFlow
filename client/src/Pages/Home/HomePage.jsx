  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 bg-[rgba(19,255,160,0.6)] opacity-5"></div>
        
        <div className="relative max-w-7xl mx-auto px-6 py-16">
          <div className="text-center">
            <div className="flex justify-center mb-8">
              <div className="p-6 bg-[rgba(19,255,160,0.6)]/20 rounded-full backdrop-blur-sm border border-[rgba(19,255,160,0.6)]/30">
            ...
            <div className="text-sm text-[rgba(19,255,160,0.6)] mb-6">
      ...
      <div className="max-w-7xl mx-auto px-6 mb-12">
        <div className="bg-[rgba(19,255,160,0.6)]/10 backdrop-blur-sm rounded-3xl p-8 border border-[rgba(19,255,160,0.6)]/20">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div className="bg-black/30 rounded-2xl p-6 border border-[rgba(19,255,160,0.6)]/20">
              <Database className="w-8 h-8 text-[rgba(19,255,160,0.6)] mx-auto mb-3" />
            ...
            <div className="bg-black/30 rounded-2xl p-6 border border-[rgba(19,255,160,0.6)]/20">
              <Globe className="w-8 h-8 text-[rgba(19,255,160,0.6)] mx-auto mb-3" />
            ...
            <div className="bg-black/30 rounded-2xl p-6 border border-[rgba(19,255,160,0.6)]/20">
              <CheckCircle className="w-8 h-8 text-[rgba(19,255,160,0.6)] mx-auto mb-3" />
            ...
            <div className="bg-black/30 rounded-2xl p-6 border border-[rgba(19,255,160,0.6)]/20">
              <Activity className="w-8 h-8 text-[rgba(19,255,160,0.6)] mx-auto mb-3" />
      ...
      <div className="max-w-7xl mx-auto px-6 pb-20">
        <div className="grid lg:grid-cols-2 gap-8">
          {appConfig.services.map((service, index) => {
            ...
            return (
              <div
                key={service.id}
                className="bg-gray-900/50 backdrop-blur-sm rounded-3xl border border-gray-700/50 shadow-lg hover:shadow-2xl hover:border-[rgba(19,255,160,0.6)]/30 transition-all duration-300 overflow-hidden"
              >
                ...
                <div className="p-8">
                  ...
                  <div className="grid gap-3">
                    {service.endpoints.map((endpoint, endpointIndex) => (
                      <div
                        key={endpointIndex}
                        className="flex items-center space-x-3 p-3 bg-black/30 rounded-xl border border-gray-700/30 hover:border-[rgba(19,255,160,0.6)]/30 transition-colors"
                      >
                        <div className="w-2 h-2 bg-[rgba(19,255,160,0.6)] rounded-full flex-shrink-0"></div>
        ...
        <div className="text-center mt-16 bg-[rgba(19,255,160,0.6)]/10 backdrop-blur-sm rounded-3xl p-8 border border-[rgba(19,255,160,0.6)]/20">
          <h3 className="text-xl font-semibold text-white mb-4">Monitoring Information</h3>
          <div className="grid md:grid-cols-3 gap-6 text-gray-300">
            <div>
              <div className="font-semibold mb-2 text-[rgba(19,255,160,0.6)]">Real-time Updates</div>
              <p className="text-sm">{appConfig.monitoring.realTimeUpdates}</p>
            </div>
            <div>
              <div className="font-semibold mb-2 text-[rgba(19,255,160,0.6)]">Last Updated</div>
              <p className="text-sm">{new Date().toLocaleString()}</p>
            </div>
            <div>
              <div className="font-semibold mb-2 text-[rgba(19,255,160,0.6)]">Service Coverage</div>
              <p className="text-sm">{appConfig.monitoring.serviceCoverage}</p>
            </div>
          </div>
        </div>

        <div className="mt-8 bg-[rgba(19,255,160,0.6)]/10 backdrop-blur-sm rounded-3xl p-8 border border-[rgba(19,255,160,0.6)]/20">
